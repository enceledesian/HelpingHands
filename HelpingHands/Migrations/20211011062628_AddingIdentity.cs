        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientInfo = table.Column<string>(unicode: false, maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContributorDetails", x => x.ContributorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DonationRequirementId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstName = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    LastName = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    Age = table.Column<int>(nullable: false),
                    MaterialItem = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonationRequirement", x => x.DonationRequirementId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MererialItemName = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeterialItems", x => x.MaterialItemId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    LastName = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    EmailId = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    Gender = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    Age = table.Column<int>(nullable: true),
                    MobileNumber = table.Column<string>(unicode: false, maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Volunteer_Email",
                table: "Volunteer",
                column: "EmailId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ_Volunteer_Mobile",
                table: "Volunteer",
                column: "MobileNumber",
                unique: true,
